...
public class CodeQualityMetricsConverterTest {
  ...
  @Test
  public void handlesEmptyJunitXml2Reports() {
    JunitXmlReportV2 testXmlReport1 = new JunitXmlReportV2();
    List<JunitXmlReportV2.TestSuite> suites = new ArrayList<>();
    Whitebox.setInternalState(testXmlReport1,"testsuite", suites);
    JunitXmlReportV2.TestSuite testSuite = new JunitXmlReportV2.TestSuite();
    suites.add(testSuite);
    testSuite.setErrors(1);
    testSuite.setFailures(0);
    testSuite.setTests(8);

    JunitXmlReportV2 testXmlReport2 = new JunitXmlReportV2();
    List<JunitXmlReportV2.TestSuite> suites2 = new ArrayList<>();
    Whitebox.setInternalState(testXmlReport2,"testsuite", suites2);
    JunitXmlReportV2.TestSuite testSuite2 = new JunitXmlReportV2.TestSuite();
    suites2.add(testSuite2);
    testSuite2.setErrors(1);
    testSuite2.setFailures(1);
    testSuite2.setTests(6);

    CodeQualityMetricsConverter testee = new CodeQualityMetricsConverter();
    testXmlReport1.accept(testee);
    testXmlReport2.accept(testee);
    CodeQuality calculatedCodeQuality = testee.produceResult();

    assertThat(calculatedCodeQuality.getMetrics())
        .extracting("name", "formattedValue", "value", "status")
        .contains(
            tuple("test_success_density", "11", "11", CodeQualityMetricStatus.Ok),
            tuple("test_failures", "1", "1", CodeQualityMetricStatus.Warning),
